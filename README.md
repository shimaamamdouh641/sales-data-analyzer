...
The dataset contains sales information such as dates, products, quantities, prices, and total sales.

The main goal of the analysis is to understand sales trends, identify the best-selling and most profitable products, and see how sales performance changes over time.
...
* The products with the highest sales
